...
* @Last Modified time: 2017-10-27 14:43:39
*/
function Snake(){
...
Snake.prototype={
	...
	move:function(){
		...
		this.t=setInterval(function(){
			...
			if(newt[1]<0 || newt[1]>19 || newt[0]<0 || newt[0]>19 || that.flag[newh]){
			...
			if(newh==that.food){
				that.arr.push(newh);
				that.flag[newh]=true;
				document.getElementById(that.food).style.background="transparent";
				that.Food();
			}else{
				that.arr.push(newh);
				that.flag[newh]=true;
